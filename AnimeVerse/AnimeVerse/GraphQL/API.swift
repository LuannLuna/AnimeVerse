...
public final class AllAnimesQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query AllAnimes($page: Int) {
      Page(page: $page) {
        __typename
        media {
          __typename
  ...
  public let operationName: String = "AllAnimes"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Page: GraphQLSelectionSet {
      ...
      public struct Medium: GraphQLSelectionSet {
        ...
        public init(id: Int, siteUrl: String? = nil, title: Title? = nil, description: String? = nil, coverImage: CoverImage? = nil) {
          self.init(unsafeResultMap: ["__typename": "Media", "id": id, "siteUrl": siteUrl, "title": title.flatMap { (value: Title) -> ResultMap in value.resultMap }, "description": description, "coverImage": coverImage.flatMap { (value: CoverImage) -> ResultMap in value.resultMap }])
        }
